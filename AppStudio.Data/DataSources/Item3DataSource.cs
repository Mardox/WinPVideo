...
{
    public class Item3DataSource : IDataSource<YouTubeSchema>
    {
        ...
        public Item3DataSource()
        {
        }

        public async Task<IEnumerable<YouTubeSchema>> LoadData()
        {
            if (IsolatedStorageSettings.ApplicationSettings.Contains("Item3Data"))
            {
                _queryString = IsolatedStorageSettings.ApplicationSettings["Item3Data"] as string;
            }
            ...
            if (_data == null)
            {
                ...
                {
                    AppLogs.WriteError("Item3DataSource.LoadData", ex.ToString());
                }
            }
            return _data;
        }
