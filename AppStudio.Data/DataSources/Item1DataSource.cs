...
{
    public class Item1DataSource : IDataSource<YouTubeSchema>
    {
        ...
        public Item1DataSource()
        {
        }

        public async Task<IEnumerable<YouTubeSchema>> LoadData()
        {
            if (IsolatedStorageSettings.ApplicationSettings.Contains("Item1Data"))
            {
                _queryString = IsolatedStorageSettings.ApplicationSettings["Item1Data"] as string;
            }
