...
{
    public class Item4DataSource : IDataSource<YouTubeSchema>
    {
        ...
        public Item4DataSource()
        {
        }

        public async Task<IEnumerable<YouTubeSchema>> LoadData()
        {
            if (IsolatedStorageSettings.ApplicationSettings.Contains("Item4Data"))
            {
                _queryString = IsolatedStorageSettings.ApplicationSettings["Item4Data"] as string;
            }
            ...
            if (_data == null)
            {
                ...
                {
                    AppLogs.WriteError("Item4DataSource.LoadData", ex.ToString());
                }
            }
            return _data;
        }
