...
{
    public class Item5DataSource : IDataSource<YouTubeSchema>
    {
        ...
        public Item5DataSource()
        {
        }

        public async Task<IEnumerable<YouTubeSchema>> LoadData()
        {
            if (IsolatedStorageSettings.ApplicationSettings.Contains("Item5Data"))
            {
                _queryString = IsolatedStorageSettings.ApplicationSettings["Item5Data"] as string;
            }
            ...
            if (_data == null)
            {
                ...
                {
                    AppLogs.WriteError("Item5DataSource.LoadData", ex.ToString());
                }
            }
            return _data;
        }
